execute if entity @a[tag=cacard.redTeam,tag=!cacard.hungry] at @e[tag=cacard.red5] run particle heart ~ ~2 ~ 0.2 0.2 0.2 0.1 5 normal
...
execute if entity @a[tag=cacard.redTeam,tag=!cacard.hungry] run scoreboard players add #cacard.redHealth cacard.health 5
