...
execute if score #cacard.time cacard.time matches 2 if score #cacard.i cacard.random matches 1 run item replace entity @a[tag=cacard.blueTeam] hotbar.8 with barrier[custom_data={cacardwar:none},enchantment_glint_override=true,custom_name={text:"\u00a7c现在不是你的回合"}] 1
...
execute if score #cacard.time cacard.time matches 2 if score #cacard.i cacard.random matches 0 run item replace entity @a[tag=cacard.redTeam] hotbar.8 with barrier[custom_data={cacardwar:none},enchantment_glint_override=true,custom_name={text:"\u00a7c现在不是你的回合"}] 1
