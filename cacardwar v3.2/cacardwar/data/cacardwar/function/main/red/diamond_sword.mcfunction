execute if entity @a[tag=cacard.blueTeam,tag=!cacard.shield] at @e[tag=cacard.blue5] run particle damage_indicator ~ ~2 ~ 0.2 0.2 0.2 0.1 7 normal
...
execute if entity @a[tag=cacard.blueTeam,tag=!cacard.shield] run scoreboard players remove #cacard.blueHealth cacard.health 7
