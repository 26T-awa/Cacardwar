...
tellraw @a[tag=cacard.ingame] [{text:"   \u00a7a当前版本:"},{storage:"cacardwar:verson-particle",nbt:"number"}]
tellraw @a[tag=cacard.ingame] {text:"   \u00a7e重加载后短时间内会重置游戏。"}
tellraw @a[tag=cacard.ingame] {text:"   \u00a7k_26T"}
tellraw @a[tag=cacard.ingame] {text:"\u00a77= = = = = = = = = = = = = = = = = = = = = = = ="}

data modify entity @e[limit=1,tag=cacard.verson] CustomName set from storage cacardwar:verson-particle number
