execute if entity @a[tag=cacard.redTeam,tag=!cacard.shield_sword] at @e[tag=cacard.red5] run particle damage_indicator ~ ~2 ~ 0.2 0.2 0.2 0.1 7 normal
...
execute if entity @a[tag=cacard.redTeam,tag=!cacard.shield_sword] run scoreboard players remove #cacard.redHealth cacard.health 7
