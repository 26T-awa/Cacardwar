...
$scoreboard players add @a[tag=cacard.$(team)Team,tag=!cacard.shield_fire] cacard.shield.count 1
...
$tag @a[tag=cacard.$(team)Team,tag=!cacard.shield_fire] add cacard.shield_fire
