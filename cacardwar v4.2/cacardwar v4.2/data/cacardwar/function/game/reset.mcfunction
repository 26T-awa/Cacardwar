...
function cacardwar:book_recipe with storage cacardwar:recipe_book
...
scoreboard players set @a[tag=cacard.ready] cacard.shield.count 0
...
scoreboard players reset @a[scores={cacard.point=0..}] cacard.point
