...
execute store result score #cacard.ai_reward_R10 cacard.point run scoreboard players operation #cacard.ai_reward_base cacard.point *= #cacard.ai_reward_power cacard.point
execute store result storage cacardwar:ai pending_sample.reward[10] double 0.00000001 run scoreboard players get #cacard.ai_reward_R10 cacard.point