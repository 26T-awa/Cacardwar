...
data modify storage cacardwar:ai matrix.l append from storage cacardwar:ai pending_sample.before[2][]
data modify storage cacardwar:ai matrix.l append from storage cacardwar:ai pending_sample.before[3][]
data modify storage cacardwar:ai matrix.l append from storage cacardwar:ai pending_sample.before[4][]
data modify storage cacardwar:ai matrix.l append from storage cacardwar:ai pending_sample.before[5][]
data modify storage cacardwar:ai matrix.l append from storage cacardwar:ai pending_sample.before[6][]
data modify storage cacardwar:ai matrix.l append from storage cacardwar:ai pending_sample.before[7][]