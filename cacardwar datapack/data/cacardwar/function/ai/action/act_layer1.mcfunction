...
item replace entity @a[tag=cacard.inAImode,limit=1,tag=!cacard.inAImode.auto] container.17 with purple_concrete[enchantment_glint_override=true,custom_name={text:"§5自动AI操作"},custom_data={cacardwar:["ai_auto","non-card"]},custom_model_data={strings:["cacardwar:ai_auto"]},lore=[]] 1
