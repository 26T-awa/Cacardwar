...
function cacardwar:main/others/loop_entry {min:0,max:10,bias:27,command:'function cacardwar:ai/action/loop/func1 with storage cacardwar:loop'}
...
function cacardwar:main/others/loop_entry {min:0,max:10,bias:27,command:'function cacardwar:ai/action/loop/func2 with storage cacardwar:loop'}
