...
$execute as @e[tag=cacard.$(team)Plot1] at @s positioned ~ ~.2 ~ if entity @e[distance=...2] as @e[tag=cacard.$(team)Plot2] at @s positioned ~ ~.2 ~ if entity @e[distance=...2] as @e[tag=cacard.$(team)Plot3] at @s positioned ~ ~.2 ~ if entity @e[distance=...2] store success score #cacard.ai_reward_arg5 cacard.players run scoreboard players add @e[tag=cacard.$(team)Trader] cacard.summonleft 1
execute if score #cacard.time cacard.isongoing matches 5 if score #cacard.ai_reward_arg5 cacard.players matches 1 run function cacardwar:ai/calculation/rule3 {arg1:0,arg2:1,arg3:0,arg4:0,arg5:1}
$execute as @e[tag=cacard.$(team)Plot1] at @s positioned ~ ~.2 ~ if entity @e[distance=...2] as @e[tag=cacard.$(team)Plot2] at @s positioned ~ ~.2 ~ if entity @e[distance=...2] as @e[tag=cacard.$(team)Plot3] at @s positioned ~ ~.2 ~ unless entity @e[distance=...2] store success score #cacard.ai_reward_arg5 cacard.players run summon wandering_trader ~ ~-.0125 ~ {NoAI:true,Silent:true,Invulnerable:true,Rotation:[$(rotation),0],Tags:["cacard.$(team)Trader","cacard.$(team)Summon3","cacard.tosummon","cacard.summoner","cacard.Trader"],DeathLootTable:"",Offers:{}}
$execute as @e[tag=cacard.$(team)Plot1] at @s positioned ~ ~.2 ~ if entity @e[distance=...2] as @e[tag=cacard.$(team)Plot2] at @s positioned ~ ~.2 ~ unless entity @e[distance=...2] store success score #cacard.ai_reward_arg5 cacard.players run summon wandering_trader ~ ~-.0125 ~ {NoAI:true,Silent:true,Invulnerable:true,Rotation:[$(rotation),0],Tags:["cacard.$(team)Trader","cacard.$(team)Summon2","cacard.tosummon","cacard.summoner","cacard.Trader"],DeathLootTable:"",Offers:{}}
$execute as @e[tag=cacard.$(team)Plot1] at @s positioned ~ ~.2 ~ unless entity @e[distance=...2] store success score #cacard.ai_reward_arg5 cacard.players run summon wandering_trader ~ ~-.0125 ~ {NoAI:true,Silent:true,Invulnerable:true,Rotation:[$(rotation),0],Tags:["cacard.$(team)Trader","cacard.$(team)Summon1","cacard.tosummon","cacard.summoner","cacard.Trader"],DeathLootTable:"",Offers:{}}
execute if score #cacard.time cacard.isongoing matches 5 if score #cacard.ai_reward_arg5 cacard.players matches 1 run function cacardwar:ai/calculation/rule3 {arg1:0,arg2:1,arg3:0,arg4:0,arg5:0}
execute if score #cacard.time cacard.isongoing matches 5 unless score #cacard.ai_reward_arg5 cacard.players matches 1 run function cacardwar:ai/calculation/rule3 {arg1:0,arg2:1,arg3:0,arg4:0,arg5:100}
