...
$give @a[tag=cacard.$(team)Team] bread[enchantment_glint_override=true,custom_name=[{text:"§a卡牌 §7-- "},{text:"§a§l新生的面包",color:"#c2a203",italic:false}],custom_data={cacardwar:["newly_bread","card"]},custom_model_data={strings:["cacardwar:newly_bread"]}] 1
