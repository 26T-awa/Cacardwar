...
give @s stick[enchantment_glint_override=true,custom_name=[{text:"§a卡牌 §7-- "},{text:"§l木棍",color:"#774205","italic":false}],custom_data={cacardwar:["stick","card","card5"],cacard.recipe1:true,cacard.recipe10:true},lore=[{text:"§7§o手持并等待以展示参与的复杂配方。"}]] 1
