...
give @s wheat[enchantment_glint_override=true,custom_name=[{text:"§a卡牌 §7-- §e§l小麦"}],custom_data={cacardwar:["wheat","card"],cacard.recipe6:true,cacard.recipe16:true},custom_model_data={strings:["cacardwar:wheat"]},lore=[{text:"§7§o手持并等待以展示参与的复杂配方。"}]]

give @s bundle[enchantment_glint_override=true,custom_name=[{text:"§a卡牌 §7-- §a§l五谷丰登"}],custom_data={cacardwar:["another_two","card"]},custom_model_data={strings:["cacardwar:another_two"]},lore=[{text:"§7§o该物品不参与任何复杂配方。"}]]

give @s nether_star[enchantment_glint_override=true,custom_name=[{text:"§a卡牌 §7-- §5§l赌徒的交易"}],custom_data={cacardwar:["deal","card"],cacard.recipe14:true},custom_model_data={strings:["cacardwar:deal"]},lore=[{text:"§7§o手持并等待以展示参与的复杂配方。"}]]

give @s wheat[enchantment_glint_override=true,custom_name=[{text:"§a卡牌 §7-- §a§l新生的小麦"}],custom_data={cacardwar:["newly_wheat","card"],cacard.recipe6:true},custom_model_data={strings:["cacardwar:newly_wheat"]},lore=[{text:"§7§o手持并等待以展示参与的复杂配方。"}]]

give @s bread[enchantment_glint_override=true,custom_name=[{text:"§a卡牌 §7-- §a§l新生的面包"}],custom_data={cacardwar:["newly_bread","card"]},custom_model_data={strings:["cacardwar:newly_bread"]},lore=[{text:"§7§o该物品不参与任何复杂配方。"}]]

give @s rotten_flesh[enchantment_glint_override=true,custom_name=[{text:"§a卡牌 §7-- §4§l腐肉"}],custom_data={cacardwar:["rotten","card"],cacard.recipe13:true},custom_model_data={strings:["cacardwar:rotten"]},lore=[{text:"§7§o手持并等待以展示参与的复杂配方。"}]]

give @s player_head[enchantment_glint_override=true,custom_name=[{text:"§a卡牌 §7-- §7§l头颅"}],custom_data={cacardwar:["head","card"],cacard.recipe8:true,cacard.recipe13:true,cacard.recipe15:true,cacard.recipe16:true},custom_model_data={strings:["cacardwar:head"]},lore=[{text:"§7§o手持并等待以展示参与的复杂配方。"}]]
