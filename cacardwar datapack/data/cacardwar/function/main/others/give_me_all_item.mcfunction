...
give @s yellow_concrete[enchantment_glint_override=true,custom_name={text:"§e<INFO>"},custom_data={cacardwar:["ai_act","card_place_info","non-card"]},custom_model_data={strings:["cacardwar:ai_act_card_place_info"]},lore=[{text:"§e<INFO>"}]] 3
