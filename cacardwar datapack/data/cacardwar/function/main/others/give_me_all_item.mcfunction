...
give @s lime_concrete[enchantment_glint_override=true,custom_name={text:"§a槽位0~9"},custom_data={cacardwar:["ai_act","slot0~9","slot","non-card"]},custom_model_data={strings:["cacardwar:ai_act_ai_act_slot0~9"]},lore=[[{text:"§a按"},{keybind:"key.swapOffhand",color:"green",italic:false},{text:"§a执行操作 §7- §a选择槽位0~9"}],"这只是一个例子"]]

give @s red_concrete[enchantment_glint_override=true,custom_name={text:"§c§m槽位0~9"},custom_data={cacardwar:["ai_act","disabled_slot","non-card"]},custom_model_data={strings:["cacardwar:ai_act_dis_slot"]},lore=[{text:"§c无法选择此槽位！"},"这只是一个例子"]]

give @s yellow_concrete[enchantment_glint_override=true,custom_name={text:"§e返回"},custom_data={cacardwar:["ai_act","ai_act_back","non-card"]},custom_model_data={strings:["cacardwar:ai_act_back"]},lore=[[{text:"§e按"},{keybind:"key.swapOffhand",color:"green",italic:false},{text:"§e返回"}]]]
