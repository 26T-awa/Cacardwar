...
tellraw @a[tag=cacard.ingame] [{text:"   §a当前版本:"},{storage:"cacardwar:main_storage",nbt:"version_number"}]
...
data modify entity @e[limit=1,tag=cacard.version] CustomName set from storage cacardwar:main_storage version_number
