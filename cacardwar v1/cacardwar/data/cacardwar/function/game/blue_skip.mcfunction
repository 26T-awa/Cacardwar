...
execute as @e[tag=cacard.red] at @s run playsound block.note_block.harp master @a ~ ~ ~ 2 2 1
...
loot give @a[tag=cacard.redTeam,tag=cacard.attack] loot cacardwar:normal/attack
loot give @a[tag=cacard.redTeam,tag=cacard.average] loot cacardwar:normal/average
loot give @a[tag=cacard.redTeam,tag=cacard.resist] loot cacardwar:normal/resist
